...
import VersementNewEditForm from '../../../sections/@dashboard/form/VersementNewEditForm';
  ...
  return (
    <Page title="Suivi des versements">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading="Suivi des versements"
          links={[{ name: 'Tableau de bord', href: PATH_DASHBOARD_ADMIN.root }, { name: 'Suivi des versements' }]}
          action={
            <Button
              variant="contained"
              onClick={() => {
