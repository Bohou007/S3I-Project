              ...
              >
                <Stack sx={{ p: 3 }}>
                  <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 1 }}>
                    ...
                    <Button
                      size="small"
                      startIcon={<Iconify icon={event ? 'eva:edit-fill' : 'eva:plus-fill'} />}
                      onClick={onOpenTo}
                    >
                ...
                <Grid item xs={12} md={6}>
                  <CardContent sx={{ marginTop: 0 }}>
                    <TextField
                      ...
                      // id="outlined-basic"
                      onChange={handleChangeEdit}
                      value={!event ? sepMillier(detailRow.additional_land_amount) : ''}
                      defaultValue={event ? '' : ' '}
                ...
                <Grid item xs={12} md={6}>
                  <CardContent sx={{ marginTop: 0 }}>
                    <TextField
                      ...
                      id="outlined-basic"
                      value={!event ? sepMillier(detailRow.additional_fence_amount) : ''}
                      onChange={handleChangeEdit}
                      defaultValue={event ? '' : ' '}
                ...
                <Grid item xs={12} md={6}>
                  <CardContent sx={{ marginTop: 0 }}>
                    <TextField
                      ...
                      id="outlined-basic"
                      value={!event ? sepMillier(detailRow.purchase_amount) : ''}
                      onChange={handleChangeEdit}
                      defaultValue={event ? '' : ' '}
                ...
                <Grid item xs={12} md={6}>
                  <CardContent sx={{ marginTop: 0 }}>
                    <TextField
                      ...
                      // id="outlined-basic"
                      onChange={handleChangeEdit}
                      value={!event ? sepMillier(detailRow.application_fees) : ''}
                      defaultValue={event ? '' : ' '}
                ...
                <Grid item xs={12} md={6}>
                  <CardContent sx={{ marginTop: 0 }}>
                    <TextField
                      name="booking_fees"
                      id="outlined-basic"
                      value={!event ? sepMillier(detailRow.booking_fees) : ''}
                      onChange={handleChangeEdit}
                      defaultValue={event ? '' : ' '}
                ...
                <Grid item xs={12} md={6}>
                  <CardContent sx={{ marginTop: 0 }}>
                    <TextField
                      ...
                      // id="outlined-basic"
                      onChange={handleChangeEdit}
                      value={!event ? sepMillier(detailRow.house_amount) : ''}
                      defaultValue={event ? '' : ' '}
                ...
                <Grid item xs={12} md={6}>
                  <CardContent sx={{ marginTop: 0 }}>
                    <TextField
                      ...
                      // disabled
                      onChange={handleChangeEdit}
                      value={!event ? sepMillier(detailRow.balance_due) : ''}
                      defaultValue={event ? '' : ' '}
                      label="Solde dû"
                      sx={{ width: '100%' }}
                    />
